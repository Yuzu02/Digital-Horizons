...
<ImageMDX src="/post/Era-IA/promramacion1.jpg" alt="programacion" width={800} height={400} />

<Parrafo>
  La Evolución de la Programación y el Desarrollo: Impacto y Controversias en la Era de la IA La programación y el desarrollo de
  software han recorrido un camino fascinante desde sus inicios, transformándose en pilares fundamentales de la tecnología
  moderna. A medida que avanzamos hacia un futuro digital, es esencial comprender cómo ha evolucionado esta disciplina, cómo nos
  beneficia en nuestra vida diaria y las controversias que surgen con la integración de la inteligencia artificial (IA).
</Parrafo>
...
<ImageMDX src="/post/Era-IA/programacion2.jpg" alt="Era IA" width="1000" height="900" />
...
<ImageMDX src="/post/Era-IA/proramacion3.jpg " alt="programación" width={800} height={400} />
...
<ImageMDX src="/post/Era-IA/programacion4.jpg" alt="programación" width={800} height={400} />
